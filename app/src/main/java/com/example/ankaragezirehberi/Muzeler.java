...
public class Muzeler extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<String> adapter = new ArrayAdapter<String>(this, android.R.layout.simple_list_item_1, android.R.id.text1,muzeler);
        ...
        liste.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long id) {
                int sira= position;
                String muzeismi= (String) liste.getItemAtPosition(position);
                switch (position){
                    case 0: yazi.setText("Anıtkabir, Türk Kurtuluş Savaşı'nın ve inkılaplarının önderi ve Türkiye Cumhuriyeti'nin ilk Cumhurbaşkanı Mustafa Kemal Atatürk'ün, Ankara Anıttepe'de (eski adıyla Rasattepe) bulunan anıt mezarıdır. Ziyaret saatleri ise şu şekildedir:\n01 Şubat - 14 Mayıs Tarihleri Arasında Açılış: 09:00 - Kapanış: 16:30.\n" +
        ...
        findViewById(R.id.button12).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent=new Intent(Muzeler.this,Maps3.class);
