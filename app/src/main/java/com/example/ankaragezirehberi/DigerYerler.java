...
public class DigerYerler extends AppCompatActivity {
    ListView liste;
    TextView yazi;
    ImageView resim;

    String[] parklar={"Millet Bahçesi","Hamamönü", "Teleferik"};
    @SuppressLint("MissingInflatedId")
    @Override
    protected void onCreate(Bundle savedInstanceState) {

        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_diger_yerler);
        ...
        liste.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long id) {
                int sira= position;
                String digerismi= (String) liste.getItemAtPosition(position);
                switch (position){
                    case 0: yazi.setText("AKM Millet Bahçesi, millet kıraathanesi, yeşil alanları, yürüyüş, koşu, bisiklet parkurları, buz pisti, dinlenme ve piknik alanlarıyla doğayla iç içe bir sosyal yaşam alanı olarak vatandaşların ilgisini çekiyor.");
        ...
        findViewById(R.id.button12).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent=new Intent(DigerYerler.this,Maps2.class);
